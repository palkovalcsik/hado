...
if($_POST) {
    ...
    $subject = 'New message from DSTNY'; // Write the subject you'll see in your inbox
    ...
    if(strlen($_POST["userMessage"])<20) {
        $output = json_encode(array('type'=>'error', 'text' => '<span><i class="icon ion-close-round"></i></span>Error on 5th field :<br>Too short message! Take your time and write a few words.'));
        die($output);
    }
